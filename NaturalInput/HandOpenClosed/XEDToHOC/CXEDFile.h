...
public:
    ...
    HRESULT ReadFrame( UINT eventIndex, CXEDTitleDataFrame* pOutFrame );
...
//----------------------------------------------------------------------------------------------------------------------
// Name: CXEDTitleDataFrame
// Desc: Class which wraps use data frames returned by the XedFile API.
//----------------------------------------------------------------------------------------------------------------------
class CXEDTitleDataFrame : public CXEDFrame
{
public:
...
private:
    ...
    CXEDTitleDataFrame( const CXEDTitleDataFrame& ); // disabled
    CXEDTitleDataFrame& operator=( CXEDTitleDataFrame& rhs );

    HRESULT AllocateBuffer( UINT uBufSize );
