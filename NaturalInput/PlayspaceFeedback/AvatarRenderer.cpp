...
// AvatarRenderer.cpp
//
// Based on the AtgAvatarRenderer code, this class renders an Xbox Avatar. It is 
// slightly modified to allow a number of rendering effects to be used.
//
...
//--------------------------------------------------------------------------------------
VOID AvatarRenderer::Render( XMMATRIX matWorld, XMMATRIX matView, XMMATRIX matProj, const XMVECTOR& vColorFilter )
{

    // Set up device state and shader constants
    PreRender( &matWorld, &matView, &matProj, vColorFilter );
    ...
    const XMVECTOR&     vColorFilter )
{
    ...
    m_pd3dDevice->SetPixelShaderConstantF(   6, (FLOAT*)&vColorFilter,           1 );
