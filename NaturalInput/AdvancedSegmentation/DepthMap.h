...
public:
    ...
    DepthMap( const USHORT* pValues, const UINT stride = DEPTH_MAP_STRIDE )
    {
        Fill( pValues, stride );
    }
    ...
    VOID Sobel( const DepthMap& inputMap );
...
private:
    ...
    DepthValue m_Values[DEPTH_MAP_HEIGHT][DEPTH_MAP_WIDTH];
};
