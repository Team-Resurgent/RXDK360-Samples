...
class Sample : public ATG::Application
{
    ...
    // Water caustics
    LPDIRECT3DARRAYTEXTURE9 m_pCausticArrayTexture;
    FLOAT m_fCausticsTexture;
...
VOID __cdecl main()
{
    ...
    // Make sure front and back buffers are gamma correct.
...
HRESULT Sample::Initialize()
{
    ...
    m_pCausticArrayTexture = m_Resource.GetArrayTexture( "WaterCaustic" );
...
HRESULT Sample::Update()
{
    ...
    m_fCausticsTexture = tex / ( 32.0f - 1.0f );
...
HRESULT Sample::Render()
{
    ...
    // Set the water caustics texture array
    m_pd3dDevice->SetPixelShaderConstantF( 2, &m_fCausticsTexture, 1 );
    m_pd3dDevice->SetTexture( 1, m_pCausticArrayTexture );
    m_pd3dDevice->SetSamplerState( 1, D3DSAMP_MINFILTERZ, D3DTEXF_POINT );
    m_pd3dDevice->SetSamplerState( 1, D3DSAMP_MAGFILTERZ, D3DTEXF_POINT );
...

    {
        ...
        m_Font.DrawText( 0, 0, 0xffffffff, L"ArrayTexture" );
