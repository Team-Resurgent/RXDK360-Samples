...
public:
                ...
                TrueSkillBar( TrueSkill* paTrueSkill, ATG::Font& font,
                              ...
                              INT iMaxNoLevels=50, BOOL bUseAlphaBlending=FALSE ) : m_font ( font )
                {
    ...
    TrueSkill* GetTrueSkill( void )
    {
        return m_paTrueSkill;
    }
    ATG::Font& GetFont( void )
    {
        return m_font;
    }
    BOOL        IsAlphaBlending( void )
    {
        return m_bUseAlphaBlend;
    }
    ...
    {
        m_fWidth = fWidth; return;
    }
    void        SetHeight( FLOAT fHeight )
    {
        m_fHeight = fHeight; return;
    }
