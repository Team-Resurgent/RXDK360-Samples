...
public:
    ...
    // Read accessors
    DOUBLE GetMu() { return m_dMu; }
    DOUBLE GetSigma() { return m_dSigma; }
    INT GetMultiplicity() { return m_iMultiplicity; }

    // Write accessors
    VOID SetMu( DOUBLE dMu ) { m_dMu = dMu; return; }
    VOID SetSigma( DOUBLE dSigma ) { m_dSigma = dSigma; return ; }
...
public:
    ...
    // read accessors
    DOUBLE GetTeam1WinProbability() { return m_dTeam1Wins; }
    DOUBLE GetTeam2WinProbability() { return m_dTeam2Wins; }
    DOUBLE GetDrawProbability() { return m_dDraw; }
