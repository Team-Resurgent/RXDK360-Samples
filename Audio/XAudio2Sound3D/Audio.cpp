...
HRESULT InitAudio()
{
    ...
    X3DAudioInitialize( SPEAKER_XBOX, SPEEDOFSOUND, g_audioState.x3DInstance );

    g_audioState.vListenerPos = XMVectorSet( 0, 0, 0, 0 );
    g_audioState.vEmitterPos = XMVectorSet( 0, 0, float( ZMAX ), 0 );
    ...
    g_audioState.listener.OrientFront.x = 0;
    g_audioState.listener.OrientFront.y = 0;
    g_audioState.listener.OrientFront.z = 1;
    g_audioState.listener.OrientTop.x = 0;
    g_audioState.listener.OrientTop.y = 1;
    g_audioState.listener.OrientTop.z = 0;
    ...
    g_audioState.emitter.OrientFront.x = 0;
    g_audioState.emitter.OrientFront.y = 0;
    g_audioState.emitter.OrientFront.z = 1;
    g_audioState.emitter.OrientTop.x = 0;
    g_audioState.emitter.OrientTop.y = 1;
    g_audioState.emitter.OrientTop.z = 0;
...
HRESULT PrepareAudio( const LPWSTR wavname )
{
    ...
    sprintf_s( strFilePath, "game:\\Media\\Sounds\\%S", wavname );
    ...
    V_RETURN( wav.ReadSample( 0, g_audioState.pbSampleData, cbWaveSize, &cbWaveSize ) );
...
HRESULT UpdateAudio( float fElapsedTime )
{
    ...
    if( g_audioState.nFrameToApply3DAudio == 0 )
    {
        ...
        {
            XMVECTOR vDelta = g_audioState.vListenerPos
                - XMVectorSet( g_audioState.listener.Position.x,
                               g_audioState.listener.Position.y,
                               g_audioState.listener.Position.z, 0 );
        ...
        if( fElapsedTime > 0 )
        {
            XMVECTOR lVelocity = ( g_audioState.vListenerPos
                                   - XMVectorSet( g_audioState.listener.Position.x,
                                                  g_audioState.listener.Position.y,
                                                  g_audioState.listener.Position.z, 0 ) ) / fElapsedTime;
            g_audioState.listener.Position.x = g_audioState.vListenerPos.x;
            g_audioState.listener.Position.y = g_audioState.vListenerPos.y;
            g_audioState.listener.Position.z = g_audioState.vListenerPos.z;
            g_audioState.listener.Velocity.x = lVelocity.x;
            g_audioState.listener.Velocity.y = lVelocity.y;
            g_audioState.listener.Velocity.z = lVelocity.z;

            XMVECTOR eVelocity = ( g_audioState.vEmitterPos
                                   - XMVectorSet( g_audioState.emitter.Position.x,
                                                  g_audioState.emitter.Position.y,
                                                  g_audioState.emitter.Position.z, 0 ) ) / fElapsedTime;
            g_audioState.emitter.Position.x = g_audioState.vEmitterPos.x;
            g_audioState.emitter.Position.y = g_audioState.vEmitterPos.y;
            g_audioState.emitter.Position.z = g_audioState.vEmitterPos.z;
            g_audioState.emitter.Velocity.x = eVelocity.x;
            g_audioState.emitter.Velocity.y = eVelocity.y;
            g_audioState.emitter.Velocity.z = eVelocity.z;
        }
