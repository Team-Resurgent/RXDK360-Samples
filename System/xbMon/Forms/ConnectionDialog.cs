...
namespace Atg.Samples.xbMon
{
    public partial class ConnectionDialog : Form
    {
        ...
        /// <summary>
        /// Determines if changes had been made to the dialog
        /// </summary>
        ...
        private static void RemoveHistory(List<string> consolesToRemove)
        {
            ...
            {
                // Remove consoles that have been manually added by the user.
                Registry.CurrentUser.DeleteSubKey("Software\\Microsoft\\XboxSDK\\xbMon\\Consoles\\"+ console,false);
            }
        }
        ...
        private static List<string> ConsolesFromXbox360Neighborhood
        {
            get
            {
                ...
                try
                {
                    ...
                    foreach (string console in XBM.Consoles)
                    {
                        if (console != null)
                        {
        ...
        private void PopulateListThread()
        {
            lock (consoleListBox)
            {
                ...
                try { defaultConsole = new XboxManagerClass().DefaultConsole; }
                catch (COMException) { }
