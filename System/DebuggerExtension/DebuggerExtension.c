...
// DebuggerExtension.c
//
// The main body of the extension, containing the plugin glue.
//
    ...
    )
{
    ...
    // to recognize 64 bit addresses.  KDEXT_64BIT also has to be defined before
    // including wdbgexts.h to get 64 bit headers for WINDBG_EXTENSION_APIS
    //
    return &ApiVersion;
}
