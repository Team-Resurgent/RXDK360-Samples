...
//--------------------------------------------------------------------------------------
template <typename T> void LittleEndianToNative( T* pData, const char* format )
{
...
//--------------------------------------------------------------------------------------
template <typename T> void NativeToLittleEndian( T* pData, const char* format )
{
    if( !littleEndianNative )
        EndianSwitchWorker( pData, pData + 1, format );
}
...
//       regardless of what endianness your current platform is.
//--------------------------------------------------------------------------------------
template <typename T> void BigEndianToNative( T* pData, const char* format )
{
    if( littleEndianNative )
        EndianSwitchWorker( pData, pData + 1, format );
}
...
//       can easily show your intent.
//--------------------------------------------------------------------------------------
template <typename T> void NativeToBigEndian( T* pData, const char* format )
{
    if( littleEndianNative )
        EndianSwitchWorker( pData, pData + 1, format );
}
